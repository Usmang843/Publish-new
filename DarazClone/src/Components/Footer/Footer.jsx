      ...
      <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          ...
          <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
            ...
            <Link to="https://www.linkedin.com/in/usman-ur-rehman-3a36311a4/" target="_blank" className="ml-3 text-gray-500">
              <svg
                fill="currentColor"
                stroke="currentColor"
                stroke-linecap="round"
            ...
            <Link to="https://github.com/Usmang843" target="_blank" className="ml-3 text-gray-500">
              <svg
                fill="currentColor"
                stroke="currentColor"
                stroke-linecap="round"
              ...
              >
                ...
                ></path>
                <circle cx="12" cy="12" r="2" stroke="none"></circle>
              </svg>
            </Link>
          </span>
        </div>
