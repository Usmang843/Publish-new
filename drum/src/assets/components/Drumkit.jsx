      ...
      <section className="main-wrapper">
        ...
        <div className="drum-kit-wrapper">
          ...
          {[
            ...
            <div
              key={index}
              data-key={drum.keyCode}
              className={`key ${drum.className}`}
            >
              <kbd>{drum.label}</kbd>
            </div>
          ))}
        ...
        {[
          ...
          <audio
            key={index}
            data-key={audio.key}
            src={`https://raw.githubusercontent.com/ArunMichaelDsouza/javascript-30-course/master/src/01-javascript-drum-kit/sounds/${audio.src}`}
          ></audio>
        ))}
      </section>
    </main>
